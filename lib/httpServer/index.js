...
class HttpServer {
    constructor(node, blockchain, operator, miner) {
        ...
        this.app.get('/home', (req, res) => {
            ...
            let addressBalance = operator.getBalanceForAddress(walletFound.getAddresses()[0]);
        ...
        //     let transactionFromBlock = blockchain.getRegistrationTransactionByStudentId('21100052d');
        ...
        this.app.post('/take-attendance', (req, res) => {
            ...
            let balance = operator.getBalanceForAddress(publicKey) / 1000000000;
            let user = blockchain.getStudentIdByPublicKey(walletFound.getAddresses()[0]);
            try {
        ...
        this.app.post('/studentId-registration', (req, res) => {
            ...
            let balance = operator.getBalanceForAddress(address) / 1000000000;
            let user = blockchain.getStudentIdByPublicKey(walletFound.getAddresses()[0]);
            try {
