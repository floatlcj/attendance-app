...
class Miner {
    ...
    static generateNextBlock(rewardAddress, feeAddress, blockchain) {
        ...
        const target = blockchain.getDifficulty(); // add target to block header
        ...
        R.forEach((transaction) => {
            ...
            if (R.all(R.equals(false), transactionInputFoundAnywhere)) {
                ...
                } else if (transaction.type === 'registration' && negativeOutputsFound === 0) {
                    selectedTransactions.push(transaction);
                } else if (transaction.type === 'attendance' && negativeOutputsFound === 0) {
                    selectedTransactions.push(transaction);
                }
