...
class Blockchain {
    ...
    getRegistrationTransactionByPublicKeyInBlocks(publicKey) {
        return R.compose(
            R.find(
                R.both(
    ...
    getRegistrationTransactionByStudentIdInBlocks(studentId) {
    ...
    checkTransaction(transaction, referenceBlockchain = this.blocks) {
        ...
        if (transaction.type === 'registration') {
            let registrationId = this.getRegistrationTransactionByStudentIdInBlocks(transaction.data.studentId);
            if (registrationId) {
            ...
            let registrationPublicKey = this.getRegistrationTransactionByPublicKeyInBlocks(transaction.data.publicKey);
